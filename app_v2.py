...
def main():
    ...
    if not st.session_state.initialized:
        ...
        st.write(f"In the following you can upload multiple product images of a Louis Vuitton Speedy bag.\n\n To analyze respective product cues and corresponding confidence score, please ensure that all images belong to the same product.")
    ...
    if uploaded_files:
        ...
        if st.button("▶️ Start Evaluation"):
            ...
            st.subheader(f"Score for Uploaded Images")
            ...
            if active_categories >= 4:
                ...
                st.error(f"❌ Score = {active_categories} \n\n Low confidence. Gather more information or look for alternatives.")
